...
img_thumbnail= Image.open(r"C:\Users\HP\MINOR_2/images/thumbnail.png")
logo= Image.open(r"C:\Users\HP\MINOR_2/images/upeslogo.png")
...
with st.container():
	st.title("MedLegible-Interpreting Doctor Notes Using Deep Learning Techniques")
